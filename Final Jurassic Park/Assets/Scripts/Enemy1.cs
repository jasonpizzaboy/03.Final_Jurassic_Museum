...
using UnityEngine;
using UnityEngine.AI;                                                   //네비게이션 시스템을 사용함

#if UNITY_EDITOR
using UnityEditor;
#endif

public class Enemy1 : LivingEntity                                       //LivingEntity를 상속하기 때문에 생명체로서의 기능을 가지고 있음
{
    private enum State
    {
        Patrol,
    ...
    private RaycastHit[] hits = new RaycastHit[10];                     //적의 공격을 범위 기반의 공격으로 할것이고, 그러면 여러개의 충돌포인트가 생기기 때문에 배열사용
